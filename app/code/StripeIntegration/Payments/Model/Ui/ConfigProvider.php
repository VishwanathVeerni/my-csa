...
class ConfigProvider implements ConfigProviderInterface
{
    ...
    protected function getElementOptions()
    {
        ...
        {
            $paymentMethodTypes = $this->getFilteredPaymentMethodTypes();
    ...
    protected function getFilteredPaymentMethodTypes(): array
    {
        $options = [];
    ...
    protected function filterMethodsByCartType($options)
    {
        $afterPayIndex = array_search("afterpay_clearpay", $options);
        if ($afterPayIndex !== false)
        {
            if (!$this->helper->getQuote() || !$this->helper->getQuote()->getId())
            {
                return $options;
            }

            if ($this->helper->getQuote()->getIsVirtual())
            {
