...
class ApplyShipping implements ResolverInterface
{
    ...
    public function resolve(
        ...
        $appliedShippingCartString = $this->stripeService->apply_shipping($address, $shippingOptionId);
        $appliedShippingCart = Zend_Json::decode($appliedShippingCartString);
        return $appliedShippingCart['results'];
    }
}
